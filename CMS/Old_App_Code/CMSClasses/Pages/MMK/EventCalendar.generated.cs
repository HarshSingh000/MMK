...
namespace CMS.DocumentEngine.Types.MMK
{
	...
	public partial class EventCalendar : TreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "MMK.EventCalendar";
		...
		/// <summary>
		/// EventCalendarShowAttendeeCount.
		/// </summary>
		[DatabaseField]
		public string EventCalendarShowAttendeeCount
		{
			get
			{
				return ValidationHelper.GetString(GetValue("EventCalendarShowAttendeeCount"), @"");
			}
			set
			{
		...
		/// <summary>
		/// EventCalendarShowAttendeeNames.
		/// </summary>
		[DatabaseField]
		public string EventCalendarShowAttendeeNames
		{
			get
			{
				return ValidationHelper.GetString(GetValue("EventCalendarShowAttendeeNames"), @"");
			}
			set
			{
		...
		public partial class EventCalendarFields : AbstractHierarchicalObject<EventCalendarFields>
		{
			...
			/// EventCalendarShowAttendeeCount.
			/// </summary>
			public string ShowAttendeeCount
			{
				get
				{
			...
			/// EventCalendarShowAttendeeNames.
			/// </summary>
			public string ShowAttendeeNames
			{
				get
				{
